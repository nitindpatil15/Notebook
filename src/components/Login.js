...
const Login = (props) => {
  ...
  return (
    ...
    <header className='for'>
      ...
      <div className='text-center mt-4'><img className="img" src={loginimg} alt="login Image" /></div>
      <h5 className='text-center text-primary mb-4'>Login</h5>
          ...
          <button type="submit" style={{fontSize:'20px'}} className="btn btn-primary my-2 "> Submit </button><br />
         
          <Link to="/signup" style={{fontSize:'15px'}} className='nav-item text-decoration-none text-dark'>Don't have login? <span className="text-primary ">Register here</span></Link>
          <div></div>
          <br />
          </div>
        </form>
